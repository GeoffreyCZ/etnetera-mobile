...
class BusinessCardView: UIScrollView {
    ...
    private func createHeader() {
        let avatarImageView = UIImageView(image: UIImage(named: content!.photoName))
    ...
    private func createContactButtons() {
        ...
        slackButton.setContent(imageName: "ic-slack", title: "Slack", callbackString: "Opening Slack app with prepicked conversation with user ID \(content!.slackUserId).")
    ...
    private func createScores() {
        self.content!.scores.forEach{ score in
            ...
            scoreView.setContent(title: score.title, score: score.value)
